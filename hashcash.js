(function() {
    ...
    function isSolution(challenge, answer_origin) {
      var answer = hash(answer_origin);
      return answer_origin.indexOf(challenge)!=-1 && answer.slice(0,3) === '000' &&  ((parseInt(answer[3],16)&0xc)==0) ;
    };
